...
df2["maximum atomic moment (µB)"]=df["SCP_3_max_moment"]
df2["element carrying largest moment"]=df["SCP_3_max_moment_sym"]
df2["theoretical density (g/cm³)"]=df["SCP_3_density"]
df2["gravimetric moment (emu/g)"]=df["SCP_3_grav_moment"]
df2["volumetric moment (emu/cm³)"]=df["SCP_3_vol_moment"]
df2["moment per atom (µB/atom)"]=df["SCP_3_atomic_moment"] 
df2["Σm x gravimetric moment"]=df["SCP_3_combined_dold_gm"]
