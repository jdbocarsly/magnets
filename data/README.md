...
the latest local `clean_pickle3.df` / `clean_df3.csv` exports, verified identical
...
the older `clean_pickle.df` MnNi2Ga result more closely. The removed row instead
...
`scripts/curate_data.py` records the one-time migration. Routine website builds
