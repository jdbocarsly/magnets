from bokeh.models import ColorBar, HoverTool, LinearColorMapper, OpenURL, TapTool
    ...
    if color in resources.discrete_columns.keys():
        ...
        for i, item in enumerate(items):
            ...
            p.circle(
                ...
                alpha=0.5,
                hover_alpha=1,
                hover_line_color="#ff7044",
                line_width=1.5,
                name="circs_{}".format(i),
                line_alpha=1,
                legend_label=item,
                muted_alpha=0.05,
                source=source2,
        ...
        colormapper = LinearColorMapper(
            palette="Plasma256", low=df[color].min(), high=df[color].max()
        )
        ...
        color_bar = ColorBar(
            ...
            major_label_text_font_size=resources.FONTSIZE,
            label_standoff=12,
